...
class ServiceListTest {
    ...
    void createSpyBarberServicer() {
        final ArrayList<Service> barberServicesOffered =
                new ArrayList<>(List.of(shaveService,
    ...
    void createSpyStylistServicer() {
        final ArrayList<Service> stylistServicesOffered =
                new ArrayList<>(List.of(dyeService,
                        new Service("Highlights", 120.0)));
        spyStylistServicer = spy(new ListingTest.TestServicerAccount(
                "Juliet","11am-2pm",
                ServiceType.STYLIST, stylistServicesOffered));
    }
    ...
    void createServiceList() {
        final ArrayList<ServicerAccount.Listing> tempList =
    ...
    void getListingOutOfBoundsIndexThrowsError() {
        ...
        assertThrows(IndexOutOfBoundsException.class,
                () -> {
                    assertNotNull(serviceList.getListing(index));
                });
    }

    @Test
    void getListReturnsCorrectListOfListings() {
        final ArrayList<ServicerAccount.Listing> expectedList =
                new ArrayList<>(List.of(shaveListing, dyeListing));
    ...
    void filterByServiceReturnsCorrectFilteredList() {
        ...
        assertEquals(expectedList,
                serviceList.filterByService(ServiceType.STYLIST));
    }
    ...
    void filterByUnavailableServiceReturnsEmptyList() {
        ...
        assertEquals(expectedList,
                serviceList.filterByService(ServiceType.NAIL_TECH));
    }

    @Test
    void filterByServiceOnEmptyListReturnsEmptyList() {
        final ServiceList emptyServiceList = new ServiceList(new ArrayList<>());
        final ArrayList<ServicerAccount.Listing> expectedList =
                new ArrayList<>((List.of()));
        assertEquals(expectedList,
                emptyServiceList.filterByService(ServiceType.BARBER));
    }
